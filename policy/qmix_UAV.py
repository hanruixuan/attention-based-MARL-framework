...
class QMIX:
    def __init__(self, args):
        ...
        if self.args.load_model:
            if os.path.exists(self.model_dir + '/rnn_net_params.pkl'):
                ...
                self.eval_mlp.load_state_dict(torch.load(path_rnn, map_location=map_location))
        ...
        self.eval_parameters = list(self.eval_qmix_net.parameters()) + list(self.eval_mlp.parameters())
        self.optimizer = torch.optim.Adam(self.eval_parameters, lr=args.learning_rate, eps=args.adam_eps)
        print('Init alg Qmix')
    ...
    def save_model(self, train_step):
        ...
        torch.save(self.eval_qmix_net.state_dict(), self.model_dir + '/' + num + '_vdn_net_params.pkl')
